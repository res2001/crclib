...
#define FASTCRC_CRC4_USE_TABLE      1
#define FASTCRC_CRC8_USE_TABLE      1
#define FASTCRC_CRC8DS_USE_TABLE    1
#define FASTCRC_CRC16_USE_TABLE     1
#define FASTCRC_CRC16MB_USE_TABLE   1

/* Разрешение компиляции отдельных функций */
/* 0 = не компилировать, 1 = компилировать, 2 = компилировать как inline (если поддерживается) */

#define FASTCRC_CRC4_ADD4           1   /* добавление в CRC4 ниббла             (можно inline) */
#define FASTCRC_CRC4_ADD8           1   /* добавление в CRC4 байта              (можно inline) */
#define FASTCRC_CRC4_BLOCK8         1   /* вычисление CRC4 блока байтов */

#define FASTCRC_CRC8_ADD8           1   /* добавление в CRC8 байта              (можно inline) */
#define FASTCRC_CRC8_BLOCK8         1   /* вычисление CRC8 блока байтов */

#define FASTCRC_CRC8DS_ADD8         1   /* добавление в Dallas CRC8 байта       (можно inline) */
#define FASTCRC_CRC8DS_BLOCK8       1   /* вычисление Dallas CRC8 блока байтов */

#define FASTCRC_CRC16_ADD8          1   /* добавление в CRC16 байта             (можно inline) */
#define FASTCRC_CRC16_ADD16         1   /* добавление в CRC16 16-битного слова  (можно inline) */
...
#define FASTCRC_CRC16MB_ADD8        1   /* добавление в MODBUS CRC16 байта        (можно inline) */
#define FASTCRC_CRC16MB_ADD16       1   /* добавление в MODBUS CRC16 16-бит слова (можно inline) */
